...
Physical Volume(1) = {1};
//+
Physical Point(100) = {112, 100, 113, 111};
//+
Physical Point(200) = {12, 10, 13, 11};
//+
Physical Point(101) = {121, 120};
//+
Physical Point(201) = {21, 20};
//+
Physical Point(102) = {116, 117};
//+
Physical Point(202) = {16, 17};
//+
Physical Point(103) = {118, 119};
//+
Physical Point(203) = {18, 19};
